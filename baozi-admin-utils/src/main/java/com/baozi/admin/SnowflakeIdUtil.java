...
/**
 * @author lizuoyang
 * @description 雪花算法生成分布式唯一ID工具类
 * @date 23:31 2020/11/7
 **/
@Slf4j
public class SnowflakeIdUtil {
    ...
    public SnowflakeIdUtil(long workerId, long dataCenterId) {
        ...
        log.info("当前机器 workerId: {}", getWorkId());
        log.info("当前机器 dataCenterId: {}", getDataCenterId());
    }
    // ==============================Methods==========================================
    /**
     * 获得下一个ID (该方法是线程安全的)
    ...
    public static String buildGenerateId(){
